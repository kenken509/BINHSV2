...
function updateFilteredUsers() {
    ...
    filteredData.value = data.searchPending3d.filter(searchPending3d => {
        ...
        const isStatusMatch = searchPending3d.status.toLowerCase().includes(searchTerm);

        const isDescriptionMatch = searchPending3d.description.toLowerCase().includes(searchTerm);
